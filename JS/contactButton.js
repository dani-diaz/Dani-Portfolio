...
firstPlatform.addEventListener('click',()=>{
    window.open("https://twitter.com/DanidiazCss");
});
secondPlatform.addEventListener('click',()=>{
    window.open("mailto:danidiaz.css@gmail.com");
});
thirdPlatform.addEventListener('click',()=>{
    window.open("https://github.com/dani-diaz");
});
fourthPlatform.addEventListener('click',()=>{
    window.open("https://www.linkedin.com/in/danidiaz8/");
});